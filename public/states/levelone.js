...
(function (DougTheSlug) {
    var levelone = (function (_super) {
        ...
        levelone.prototype.preload = function () {
            ...
            this.game.load.image("mudlevel", "/images/mudlevel.png");
        ...
        levelone.prototype.startScreen = function () {
            this.game.world.remove(this.startText);
            this.game.world.remove(this.startText2);
        };
        levelone.prototype.treefall = function () {
        ...
        levelone.prototype.snowMaker = function () {
            //CREATE SNOWMEN
            for (var i = 0; i < 4; i++) {
        ...
        levelone.prototype.mushMaker = function () {
            for (var i = 0; i < 2; i++) {
        ...
        levelone.prototype.collisionHandler = function (doug, snowman) {
        ...
        levelone.prototype.scoreBoard = function (doug, mushroom) {
    ...
    DougTheSlug.levelone = levelone;
})(DougTheSlug || (DougTheSlug = {}));
